...
def main():
  ...
  print(f"{F.LIGHTYELLOW_EX}\n===================== YOUTUBE SPAMMER PURGE 2 v" + version + f" ====================={S.R}")
  print("=========== https://github.com/sunnystew22/YT-Spammer-Purge-2 ===========")
  print("================= Author: Sunnystew ================ \n")
...
# ============================================================================ RECENT VIDEOS ==========================================================================================================
      ...
      while validEntry == True or confirm == True:
        videosToScan=[]
        validConfigSetting = True
